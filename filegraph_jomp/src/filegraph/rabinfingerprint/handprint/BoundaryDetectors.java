package filegraph.rabinfingerprint.handprint;

import filegraph.rabinfingerprint.fingerprint.RabinFingerprintLong;
import filegraph.rabinfingerprint.handprint.FingerFactory.ChunkBoundaryDetector;
...
public class BoundaryDetectors {
	...
	public static final ChunkBoundaryDetector DEFAULT_BOUNDARY_DETECTOR = new BitmaskBoundaryDetector(0x1FFF, 0);
}
