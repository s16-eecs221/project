...
#  
# Compile the project  
java -jar omp4j/target/scala-2.10/omp4j-assembly-1.2.jar -d test -classpath $JAR_PATH/guava-19.0.jar:$JAR_PATH/commons-codec-1.9.jar:$JAR_PATH/json-20160212.jar @$PROJECT_PATH/sources.list
#
# eof
